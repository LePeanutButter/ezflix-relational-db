...
INSERT INTO Versiones (idVersion,idSerie, nombre, descripcion, categoria, edad,idioma) VALUES ('900005','300000000000000003', 'Last Mimzy, The', 'ullamcorper augue a suscipit nulla', 'Ciencia FicciÃ³n', 13, 'English');
...
INSERT INTO MetodosDePago (idCuenta, numero, nombre, cvv, fechaExpiracion) VALUES ('400000000000000001', 99999999999999, 'Ricardo','100', TO_DATE('25/03/2028', 'DD/MM/YYYY'));
INSERT INTO MetodosDePago (idCuenta, numero, nombre, cvv, fechaExpiracion) VALUES ('400000000000000002', 353760521987122, 'Miguel','200', TO_DATE('25/03/2028', 'DD/MM/YYYY'));
INSERT INTO MetodosDePago (idCuenta, numero, nombre, cvv, fechaExpiracion) VALUES ('400000000000000003', 357909306274002, 'Sofia','300', TO_DATE('25/03/2028', 'DD/MM/YYYY'));
