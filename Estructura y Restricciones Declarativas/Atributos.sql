...
ALTER TABLE Temporadas ADD CONSTRAINT CK_Temporadas_numero CHECK (numeroTemporada > 0);
ALTER TABLE Episodios ADD CONSTRAINT CK_Episodios_numero CHECK (numeroEpisodio > 0);
